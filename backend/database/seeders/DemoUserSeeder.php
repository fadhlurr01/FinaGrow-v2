...
class DemoUserSeeder extends Seeder
{
    ...
    {
        // Safely clear demo data tables before re-seeding
        ...
        $demoAdmin = User::updateOrCreate(
            ...
            [
                ...
                'cost_center' => 'CC-ID-JAB-204',
                'employee_id' => 'EMP-98839211',
            ]
        );
        ...
        $demoUser = User::updateOrCreate(
            ...
            [
                ...
                'cost_center' => 'CC-ID-JKT-101',
                'employee_id' => 'EMP-44219082',
            ]
        );
    ...
    public static function seedExactEnterpriseTransactions(User $user, string $prefix = 'JE'): void
    {
        ...
        // Seed Enterprise Chart of Accounts for Demo Admin
        $enterpriseCoas = [
        ...
        foreach ($enterpriseCoas as $c) {
            CoaAccount::create([
                'id' => 'AC_' . $prefix . '_' . $c['code'],
                'user_id' => $user->id,
                'code' => $c['code'],
                'name' => $c['name'],
